package com.ragty.universe.Crawler;

import com.ragty.universe.Analyzer.Fetcher;
import com.ragty.universe.index.JedisIndex;
...
public class Crawler {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Elements paras = wf.fetchUrl(source);
        ...
        while (wc.queueSize() > 0) {
            ...
            if (wc.queueSize() == 0) {
                wc = new Crawler(lastLink, index);
                paras = wf.fetchUrl( lastLink);
                wc.queueInternalLinks(paras);
